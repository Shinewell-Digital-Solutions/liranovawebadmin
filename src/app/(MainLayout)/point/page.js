      ...
      >
        {({ values, handleSubmit, setFieldValue, errors }) => (
          <>
            ...
            <Col sm="12"><UserTransationsTable filterHeader={{customTitle:"transactions"}} pointTable url={PointUserTransations} moduleName="user_transactions" setFieldValue={setFieldValue} userIdParams={true} ref={refRefetch} dateRange={true} paramsProps={{ consumer_id: values["consumer_id"] ? values["consumer_id"] : null }} /></Col>
          </>
        )}
      </Formik>
    </div>
