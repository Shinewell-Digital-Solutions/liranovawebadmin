      ...
      >
        {({ values, handleSubmit, setFieldValue }) => (
          <>
            ...
            <Col sm="12">
              <UserTransationsTable filterHeader={{ customTitle: "transactions" }} url={VendorTransations} moduleName="user_transactions" setFieldValue={setFieldValue} values={values} ref={refRefetch} dateRange={true} userIdParams={true} paramsProps={{ vendor_id: values["vendor_id"] ? values["vendor_id"] : null }} />
            </Col>
          </>
        )}
      </Formik>
