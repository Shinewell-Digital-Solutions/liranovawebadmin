            ...
            <Formik
                ...
                {({ values, handleSubmit, setFieldValue }) => (
                    <>
                        ...
                        <Col sm="12">
                             <UserTransationsTable filterHeader={{customTitle:"Transactions"}} url={UserTransations} moduleName="user_transactions" setFieldValue={setFieldValue}  userIdParams={true} ref={refRefetch} dateRange={true} paramsProps={{ consumer_id: values["consumer_id"] ? values["consumer_id"] : null }} />
                        </Col>
                    </>
                )}
            </Formik>
