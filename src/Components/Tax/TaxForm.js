    ...
    <Formik
      ...
      {({ values }) => (
        <Form className="theme-form theme-form-2 mega-form">
          ...
          <SimpleInputField nameList={[{ name: "name", placeholder: t("enter_tax_title"), require: "true" }, { name: "rate", type: "number", placeholder: t("enter_rate"), require: "true", inputaddon: "true", postprefix: "%", min: "0", max: "100" }]} />
