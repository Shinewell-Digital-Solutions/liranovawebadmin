...
const DealOfProductTabs = ({ setFieldValue, values, productData, setSearch }) => {
    ...
    return (
        <>
            ...
            <Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][product_with_deals][deal_of_days][deals]" || [], [...values['content']['product_with_deals']['deal_of_days']['deals'], { title: "", description: "" }])} title="add_deals" />
            {
