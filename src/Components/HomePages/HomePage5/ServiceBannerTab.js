...
const ServiceBannerTab = ({ values, setFieldValue }) => {
    ...
    return (
        <>
            ...
            {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][services_banner][services]" || [], [...values['content']['services_banner']['services'] || [], { title: "", description: "" }] || [])} title="add_service" />}
            {
